...
OrderGoods.initColumn = function () {
    return [
        ...
        {title: '退费', field: 'userIn', visible: true, align: 'center', valign: 'middle'},
...
OrderGoods.search = function () {
    ...
    queryData['restaurantName'] = $("#restaurantName").val();
    OrderGoods.table.refresh({query: queryData});
};

$(function () {
    var defaultColunms = OrderGoods.initColumn();
    var table = new BSTable(OrderGoods.id, "/user/order_goods_td/list", defaultColunms);
