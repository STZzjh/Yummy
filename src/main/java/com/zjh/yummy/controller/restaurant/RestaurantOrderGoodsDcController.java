...
@Controller
@RequestMapping("restaurant/order_goods_dc")
public class RestaurantOrderGoodsDcController {

    @Autowired
    private OrderGoodsService orderGoodsService;
    private String prefix = "restaurant/order_goods_dc/";

    @RequestMapping(value = "",method = RequestMethod.GET)
    public String index(){
        return prefix + "order_goods_dc";
    }
