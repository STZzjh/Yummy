        ...
        <div class="form-horizontal">
            ...
            <div class="row">
                <div class="col-sm-6 b-r">
                    ...
                    <form:select id="userId" name="用户" underline="true">
                        <c:forEach var="obj" items="${userList}">
                            <option value="${obj.id}" ${item.userId== obj.id?"selected":""}>${obj.name}</option>
                        </c:forEach>
                    </form:select>
...
<script src="/static/app/js/restaurant/order_goods/order_goods_info.js?v=0.123"></script>
</body>
</html>