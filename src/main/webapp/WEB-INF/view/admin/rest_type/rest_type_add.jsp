...
<head>
    ...
    <title>餐厅类型新增 - ${seo.mainName}</title>
        ...
        <div class="form-horizontal">
            ...
            <div class="row">
                <div class="col-sm-6 b-r">
                    <form:input id="name" name="分类名称" underline="true"/>
                </div>
            ...
            <div class="row btn-group-m-t">
                <div class="col-sm-10">
                    <form:button btnCss="info" name="提交" id="ensure" icon="fa-check" onclick="RestTypeInfoDlg.addSubmit()"/>
