...
$(function () {
    ...
    function NavToggle($that) {
        var tmenu = $that.find(".treeview-menu");
        tmenu.toggle();
        if(tmenu.is(":hidden")){
            $that.find("a.bbq-title>span.fa").removeClass("fa-chevron-down");
            $that.find("a.bbq-title>span.fa").addClass("fa-chevron-left");
        }else{
            $that.find("a.bbq-title>span.fa").removeClass("fa-chevron-left");
            $that.find("a.bbq-title>span.fa").addClass("fa-chevron-down");
        }
    }
});
