var BBQ = {
    ...
    imageFormatter:function(value,row,index){
        return "<img width='100px' height='100px' src='"+BBQ.ctxPath+"/"+value+"' />";
    },
        ...
        $.ajaxSetup({
            ...
            complete: function (XMLHttpRequest, textStatus) {
                ...
                if (sessionstatus == "timeout") {
                    //如果超时就处理 ，指定要跳转的页面
                    window.location = BBQ.ctxPath + "/global/sessionError";
                }
            }
        });
    },
    ...
    newCrontab: function (href, menuName) {
        ...
        if (needCreateCrontab) {
            ...
            var iframeContent = '<iframe class="J_iframe" name="iframe' + BBQ.randomNum(100,999) + '" width="100%" height="100%" src="' + dataUrl + '" frameborder="0" data-id="' + dataUrl + '" seamless></iframe>';
