...
OrderGoods.initColumn = function () {
    return [
        ...
        {title: '消费', field: 'price', visible: true, align: 'center', valign: 'middle'},
        {title: '用户退费', field: 'userIn', visible: true, align: 'center', valign: 'middle'},
    ];
};
...
$(function () {
    ...
    var table = new BSTable(OrderGoods.id, "/admin/order_goods_hy/list", defaultColunms);
