...
OrderTimeInfoDlg.addSubmit = function() {
    ...
    //提交信息
    $.post(BBQ.ctxPath + "/restaurant/order_time/add", this.orderTimeInfoData ,function(data){
        BBQ.success("添加成功!");
...
OrderTimeInfoDlg.editSubmit = function() {
    ...
    //提交信息
    $.post(BBQ.ctxPath + "/restaurant/order_time/update",this.orderTimeInfoData, function(data){
        BBQ.success("修改成功!");
        window.parent.OrderTime.table.refresh();
        OrderTimeInfoDlg.close();
    });
